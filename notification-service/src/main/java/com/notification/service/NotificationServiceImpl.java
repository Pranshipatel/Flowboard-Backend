...
public class NotificationServiceImpl implements NotificationService {
    ...
    public NotificationResponse send(SendNotificationRequest request) {
        ...
        // Build notification entity from request
        ...
        // Send email only when explicitly requested and email is valid
    ...
    public List<NotificationResponse> getByRecipientAndType(Long recipientId, NotificationType type) {
        return repository.findByRecipientIdAndTypeOrderByCreatedAtDesc(recipientId, type)
                .stream().map(this::toResponse).toList();
    }
    ...
    public NotificationResponse markAsRead(Long notificationId, Long recipientId) {
        ...
        // Ensure notification belongs to the user (access control)
    ...
    @Override
    @Transactional
    public void notifyDueDateApproaching(Long recipientId, Long cardId,
        ...
        req.setMessage("Card '" + cardTitle + "' is due in " + timeLeft + ". Mark it done to clear.");
        req.setRelatedId(cardId);
        req.setRelatedType("CARD");
        req.setDeepLinkUrl("/cards/" + cardId);
        req.setSendEmail(false);
